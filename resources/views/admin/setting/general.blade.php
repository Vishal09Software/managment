                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('business_phone') is-invalid @enderror"
                                        id="business_phone" name="business_phone" placeholder="Business Phone"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="email" class="form-control @error('business_email') is-invalid @enderror"
                                        id="business_email" name="business_email" placeholder="Business Email"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text"
                                        ...
                                        id="business_address" name="business_address" placeholder="Business Address"
                                        value="{{ old('business_address', $settings->business_address ?? '') }}" required>
                                ...
                                <div class="form-floating input-group">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" class="form-control @error('gst_number') is-invalid @enderror"
                                            ...
                                            value="{{ old('gst_number', $settings->gst_number ?? '') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('bank_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('bank_name', $settings->bank_name ?? '') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('account_no') is-invalid @enderror"
                                        id="account_no" name="account_no" placeholder="Account Number"
                                        value="{{ old('account_no', $settings->account_no ?? '') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('ifsc_code') is-invalid @enderror"
                                        ...
                                        value="{{ old('ifsc_code', $settings->ifsc_code ?? '') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text"
                                        ...
                                        value="{{ old('account_holder_name', $settings->account_holder_name ?? '') }}"
                                        required>
