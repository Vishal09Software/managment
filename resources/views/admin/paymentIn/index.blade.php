                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('transactions.payment-in.create') }}" class="btn btn-outline-primary"><i
                                            class="bi bi-plus-circle me-1"></i> Create Payment</a>
                                </div>
                            </div>

                            <!-- Custom Search Filters -->
                            <form action="{{ route('transactions.payment-in.index') }}" method="GET"
                                ...
                                <div class="col-md-3 text-center">
                                    ...
                                    <a href="{{ route('transactions.payment-in.index') }}" class="btn btn-outline-secondary shadow-sm"
                                        title="Reset">
                                ...
                                <tbody>
                                    @forelse ($payments as $payment)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('transactions.payment-in.receipt', $payment->id) }}"
                                                    class="btn btn-sm btn-outline-primary">
                                                    <i class="bi bi-printer"></i>
                                                </a>

                                                <a href="{{ route('transactions.payment-in.edit', $payment->id) }}"
                                                    class="btn btn-sm btn-outline-primary">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form
                                                                    action="{{ route('transactions.payment-in.destroy', $payment->id) }}"
